...
public class ProductManager implements ProductService {
	...
	@Override
	public DataResult<List<Product>> getByNameAndCategory(String prdouctName, int categoryId) {
		return new SuccessDataResult<List<Product>>(this.productDao.getByNameAndCategory(prdouctName, categoryId),
				"Data Listelendi");
	}
